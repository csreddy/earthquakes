...
class EarthquakesControllerTest < ActionController::TestCase
  ...
  test "should create earthquake" do
    assert_difference('Earthquake.count') do
      post :create, earthquake: { latitude: @earthquake.latitude, longitude: @earthquake.longitude, magnitude: @earthquake.magnitude, place: @earthquake.place, time: @earthquake.time }
    end
  ...
  test "should update earthquake" do
    put :update, id: @earthquake, earthquake: { latitude: @earthquake.latitude, longitude: @earthquake.longitude, magnitude: @earthquake.magnitude, place: @earthquake.place, time: @earthquake.time }
    assert_redirected_to earthquake_path(assigns(:earthquake))
  end
